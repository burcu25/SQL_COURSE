...
====================================================*/
	...
	/*invoices tablosunda 2010 ve 2019 arası bir tarihte (InvoiceDate) sadece şubat aylarında 
	gerçekleşmiş olan faturaların tüm bilgilerini listeleyen sorguyu yazınız*/
